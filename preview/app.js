...
if (key === "growth" && cur && cur.pop) {
      ...
      if (KK && KK[curName] && KK[curName].ka7 != null) {
        ...
        if (!dHigh && !ka7High) {
          ...
          var ka7ReasonA = ka7TrendA === "declining"
            ? "住民一人当たり負債額はこの5年で" + (ka7Td_A ? ka7Td_A.text : "減少") + "しており、着実に返済が進んでいる長期返済中、という可能性も考えられます。"
          ...
          linkMsgD = ka7TrendB === "declining"
            ? "<strong style='color:#3a9970;'>[財政]</strong>毎年の返済負担は重めですが、<strong style='color:#c0623a;'>[公会計]</strong>借金の残高自体はそれほど大きくありません。住民一人当たり負債額はこの5年で" + (ka7Td_B ? ka7Td_B.text : "減少") + "しており、短期集中で返済を終えつつある可能性も考えられます。"
        ...
        if (!ka3Near) {
          ...
          if (!uHighF && !ka3High) { ka3Judge = "中央値より低め"; ka3Body = "<strong style='color:#3a9970;'>[財政]</strong>将来への借金・<strong style='color:#c0623a;'>[公会計]</strong>施設の老朽化、どちらの面から見ても軽い状態です。"; }
            ...
            var ka3Reason = ka1TrendA === "growing"
              ? "住民一人当たり資産額はこの5年で" + (ka1Td_A ? ka1Td_A.text : "増加") + "しており、②既存施設を活用しながら、新しい整備も進めている可能性も考えられます。"
    ...
    for(var k=0;k<vals.length;k++){
      ...
      if(last && isValley) dots+="<text x='"+px(k)+"' y='"+(py(vals[k])+19)+"' text-anchor='"+lblAnchor+"' font-size='12' fill='"+c+"' font-weight='700'>"+dispVal+"</text>";
      else if(last) dots+="<text x='"+px(k)+"' y='"+(py(vals[k])-9)+"' text-anchor='"+lblAnchor+"' font-size='12' fill='"+c+"' font-weight='700'>"+dispVal+"</text>";
      else if(isValley) dots+="<text x='"+px(k)+"' y='"+(py(vals[k])+16)+"' text-anchor='"+lblAnchor+"' font-size='9' fill='"+c+"' opacity='0.75'>"+dispVal+"</text>";
      else dots+="<text x='"+px(k)+"' y='"+(py(vals[k])-8)+"' text-anchor='"+lblAnchor+"' font-size='9' fill='"+c+"' opacity='0.75'>"+dispVal+"</text>";
    }
    ...
    if (code === "ka7" && cur.d != null) {
      ...
      if (!dHighRec && !ka7HighRec) { judgeD = "軽め"; bodyD = "借金の重さは、<strong style='color:#3a9970;'>[財政]</strong>毎年の返済負担・<strong style='color:#c0623a;'>[公会計]</strong>残高の規模どちらから見ても軽めです。"; }
        ...
        var ka7ReasonC = ka7TrendC === "declining"
          ? "住民一人当たり負債額はこの5年で" + (ka7Td_C ? ka7Td_C.text : "減少") + "しており、着実に返済が進んでいる長期返済中、という可能性も考えられます。"
          : "新しい借入も続いており、返済はこれから本格化する可能性も考えられます。";
        ...
        bodyD = ka7TrendD === "declining"
          ? "<strong style='color:#3a9970;'>[財政]</strong>毎年の返済負担は重めですが、<strong style='color:#c0623a;'>[公会計]</strong>借金の残高自体はそれほど大きくありません。住民一人当たり負債額はこの5年で" + (ka7Td_D ? ka7Td_D.text : "減少") + "しており、短期集中で返済を終えつつある可能性も考えられます。"
          : "<strong style='color:#3a9970;'>[財政]</strong>毎年の返済負担は重めですが、<strong style='color:#c0623a;'>[公会計]</strong>借金の残高自体はそれほど大きくありません。返済期間を短く設定している可能性も考えられます。";
      }
      ...
      if (code === "ka3") {
        ...
        if (!uHighRec && !highRec) { judgeU = "軽め"; bodyU = "<strong style='color:#3a9970;'>[財政]</strong>将来への借金・<strong style='color:#c0623a;'>[公会計]</strong>施設の老朽化、どちらの面から見ても軽い状態です。"; }
          ...
          var ka3ReasonB = ka1TrendB === "growing"
            ? "住民一人当たり資産額はこの5年で" + (ka1Td_B ? ka1Td_B.text : "増加") + "しており、②既存施設を活用しながら、新しい整備も進めている可能性も考えられます。"
            : "①必要な投資が行われず、老朽化対策が先送りにされている可能性も考えられます。";
  ...
  function kkOpenDetail(code, skipPush){
    ...
    if (kkVals.length >= 2 && kkVals.every(function(v){ return v != null; })) {
      ...
      for (var kj=0; kj<kkVals.length; kj++){
        ...
        if (kkLast && kkIsValley) kkDots += "<text x='"+pxk(kj)+"' y='"+(pyk(kkVals[kj])+19)+"' text-anchor='"+kkAnchor+"' font-size='12' fill='"+kkC+"' font-weight='700'>"+kkLbl+"</text>";
        else if (kkLast) kkDots += "<text x='"+pxk(kj)+"' y='"+(pyk(kkVals[kj])-9)+"' text-anchor='"+kkAnchor+"' font-size='12' fill='"+kkC+"' font-weight='700'>"+kkLbl+"</text>";
        else if (kkIsValley) kkDots += "<text x='"+pxk(kj)+"' y='"+(pyk(kkVals[kj])+16)+"' text-anchor='"+kkAnchor+"' font-size='9' fill='"+kkC+"' opacity='0.75'>"+kkLbl+"</text>";
        else kkDots += "<text x='"+pxk(kj)+"' y='"+(pyk(kkVals[kj])-8)+"' text-anchor='"+kkAnchor+"' font-size='9' fill='"+kkC+"' opacity='0.75'>"+kkLbl+"</text>";
      }
