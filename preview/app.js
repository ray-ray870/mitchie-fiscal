...
if (key === "growth" && cur && cur.pop) {
  ...
  function nkZoneListHtml(clickableId, zoneKey){
    ...
    var html = "<p style='font-size:12px;font-weight:700;color:"+lbl[1]+";margin:8px 0 4px;'>「"+lbl[0]+"」の自治体（"+list.length+"件）</p>";
    for (var i=0; i<list.length; i++){
      html += nkPrefRow(list, i, mineSet);
    }
    return html;
  }
  function nkDistHtml(){
      ...
      body.addEventListener("click", function(e){
        ...
        if (zoneEl) {
          ...
          if (alreadyOpen) {
            ...
            drill.innerHTML = nkZoneListHtml(storeId, zone);
          }
        }
      });
    }
