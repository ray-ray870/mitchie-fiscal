(function() {
  ...
  var META = {
    ...
    unit:"",hib:false},
    furusato:{icon:"🎁",label:"ふるさと納税受入額",desc:"",htmlDesc:"",unit:"万円",hib:false}
  };
  ...
  function openD(key, skipPush) {
      ...
      function buildMiniChart(arr, lineColor, textColor, labelBg, gradId){
        ...
        for (var j=0;j<n;j++){
          ...
          if (isLast) {
            ...
            dots += "<text x='"+pts[j][0].toFixed(1)+"' y='"+ly.toFixed(1)+"' text-anchor='middle' font-size='9.5' font-weight='600' fill='"+textColor+"'>"+fmtFuruShort(arr[j])+"</text>";
          }
        }
    ...
    if (key === "reserve" && cur && cur.sfs && cur.sfs > 0) {
      ...
      if (KK && KK[curName] && KK[curName].ka4 != null) {
        ...
        var linkMsgR, ka4Judge;
        if (!ka4Near) {
        if (!rHigh && !ka4High) {
          ka4Judge = "中央値より低め";
          linkMsgR = "財政の体力は、<strong style='color:#3a9970;'>[財政]</strong>すぐ使える貯金・<strong style='color:#c0623a;'>[公会計]</strong>資産全体の自己資本どちらから見ても心もとない水準です。";
        } else if (rHigh && ka4High) {
          ka4Judge = "中央値より高め";
          linkMsgR = "財政の体力は、<strong style='color:#3a9970;'>[財政]</strong>すぐ使える貯金・<strong style='color:#c0623a;'>[公会計]</strong>資産全体の自己資本どちらから見ても厚めです。";
        } else if (rHigh && !ka4High) {
          ka4Judge = "中央値より低め";
          linkMsgR = "<strong style='color:#3a9970;'>[財政]</strong>すぐ使える貯金は多めですが、<strong style='color:#c0623a;'>[公会計]</strong>資産全体でみると借入への依存度は低くありません。貯金と長期的な財産形成は別物です。";
        } else {
          ka4Judge = "中央値より高め";
          linkMsgR = "<strong style='color:#3a9970;'>[財政]</strong>すぐ使える貯金は少なめですが、<strong style='color:#c0623a;'>[公会計]</strong>資産全体でみると借入に頼らず財産を築けています。日々の備えと長期的な財産形成は別物です。";
        }
        topSummaryHtml += kkCrossBox("🔗 公会計と合わせて見ると",
          "すぐ使える貯金", ratio.toFixed(1)+"%", rHigh?"多め":"やや少なめ",
          "自己資本の厚み", ka4v+"%", ka4Judge,
          curName + "は公会計でみた純資産比率が" + ka4v + "%です。" + linkMsgR);
...
if (key === "growth" && cur && cur.pop) {
    ...
    if (key === "debt" && cur) {
      ...
      if (KK && KK[curName] && KK[curName].ka7 != null) {
        ...
        var linkMsgD, ka7Judge;
        if (!ka7Near) {
        if (!dHigh && !ka7High) {
          ka7Judge = "中央値より低め";
          linkMsgD = "借金の重さは、<strong style='color:#3a9970;'>[財政]</strong>毎年の返済負担・<strong style='color:#c0623a;'>[公会計]</strong>残高の規模どちらから見ても軽めです。";
        } else if (dHigh && ka7High) {
          ka7Judge = "中央値より高め";
          linkMsgD = "借金の重さは、<strong style='color:#3a9970;'>[財政]</strong>毎年の返済負担・<strong style='color:#c0623a;'>[公会計]</strong>残高の規模どちらから見ても重めです。";
        } else if (!dHigh && ka7High) {
          ka7Judge = "中央値より高め";
          var ka7Old_A = KK[curName].ka7_r4;
          var ka7Td_A = trendDescribe(ka7Old_A, ka7v, "万円", 1);
          var ka7TrendA = kkMetricTrend(KK[curName], "ka7", ka7v);
          var ka7ReasonA = ka7TrendA === "declining"
            ? "住民一人当たり負債額はこの5年で" + (ka7Td_A ? ka7Td_A.text : "減少") + "っており、着実に返済が進んでいる長期返済中、という可能性も考えられます。"
            : "新しい借入も続いており、返済はこれから本格化する可能性も考えられます。";
          linkMsgD = "<strong style='color:#3a9970;'>[財政]</strong>毎年の返済負担は軽めに見えますが、<strong style='color:#c0623a;'>[公会計]</strong>借金の残高自体は大きめです。" + ka7ReasonA;
        } else {
          ka7Judge = "中央値より低め";
          var ka7Old_B = KK[curName].ka7_r4;
          var ka7Td_B = trendDescribe(ka7Old_B, ka7v, "万円", 1);
          var ka7TrendB = kkMetricTrend(KK[curName], "ka7", ka7v);
          linkMsgD = ka7TrendB === "declining"
            ? "<strong style='color:#3a9970;'>[財政]</strong>毎年の返済負担は重めですが、<strong style='color:#c0623a;'>[公会計]</strong>借金の残高自体はそれほど大きくありません。住民一人当たり負債額はこの5年で" + (ka7Td_B ? ka7Td_B.text : "減少") + "っており、短期集中で返済を終えつつある可能性も考えられます。"
            : "<strong style='color:#3a9970;'>[財政]</strong>毎年の返済負担は重めですが、<strong style='color:#c0623a;'>[公会計]</strong>借金の残高自体はそれほど大きくありません。返済期間を短く設定している可能性も考えられます。";
        }
        topSummaryHtml += kkCrossBox("🔗 公会計と合わせて見ると",
          "毎年の返済負担", cur.d+"%", dHigh?"重め":"軽め",
          "借金残高そのもの", ka7v+"万円", ka7Judge,
          curName + "は公会計でみた住民一人当たり負債額が" + ka7v + "万円です。" + linkMsgD);
        topSummaryHtml += KK_CROSSCHECK_CAVEAT;
        }
      }
    }
    ...
    if (key === "future" && cur) {
      ...
      var uHighF = cur.u > 100;
      var kkCrossBoxShownF = false;
      if (KK && KK[curName] && KK[curName].ka3 != null) {
        var ka3v = KK[curName].ka3;
        var ka3Med = isPrefView ? KK_MEDIANS.ka3.pref : KK_MEDIANS.ka3.muni;
        var ka3Near = Math.abs(ka3v - ka3Med) <= ka3Med * 0.1;
        var ka3High = ka3v > ka3Med;
        if (!ka3Near) {
          var ka3Judge, ka3Body;
          if (!uHighF && !ka3High) { ka3Judge = "中央値より低め"; ka3Body = "<strong style='color:#3a9970;'>[財政]</strong>将来への借金・<strong style='color:#c0623a;'>[公会計]</strong>施設の老朽化、どちらの面から見ても軽い状態です。"; }
          else if (uHighF && ka3High) { ka3Judge = "中央値より高め"; ka3Body = "<strong style='color:#3a9970;'>[財政]</strong>将来への借金・<strong style='color:#c0623a;'>[公会計]</strong>施設の老朽化、どちらの面から見ても重い状態です。老朽化した施設の更新をこれから借金で行うと、将来負担がさらに増える可能性があります。"; }
          else if (!uHighF && ka3High) {
            ka3Judge = "中央値より高め";
            var ka1v_A = KK[curName].ka1;
            var ka1Old_A = KK[curName].ka1_r4;
            var ka1Td_A = trendDescribe(ka1Old_A, ka1v_A, "万円", 1);
            var ka1TrendA = kkMetricTrend(KK[curName], "ka1", ka1v_A);
            var ka3Reason = ka1TrendA === "growing"
              ? "住民一人当たり資産額はこの5年で" + (ka1Td_A ? ka1Td_A.text : "増加") + "えており、②既存施設を活用しながら、新しい整備も進めている可能性も考えられます。"
              : "①必要な投資が行われず、老朽化対策が先送りにされている可能性も考えられます。";
            ka3Body = "<strong style='color:#3a9970;'>[財政]</strong>将来への借金は軽めですが、<strong style='color:#c0623a;'>[公会計]</strong>施設の老朽化は進んでいます。" + ka3Reason;
          }
          else { ka3Judge = "中央値より低め"; ka3Body = "<strong style='color:#3a9970;'>[財政]</strong>将来への借金は重めですが、<strong style='color:#c0623a;'>[公会計]</strong>施設の老朽化は進んでいません。借金をしてでも施設の更新・整備を積極的に進めている可能性があります。"; }
          topSummaryHtml += kkCrossBox("🏛️ 総務省公式の組み合わせ分析<br><span style='color:#3a9970;'>将来負担比率</span>×<span style='color:#c0623a;'>老朽化率</span>",
            "将来への借金", cur.u+"%", uHighF?"重め":"軽め",
            "施設の老朽化率", ka3v+"%", ka3Judge,
            curName + "は公会計でみた有形固定資産減価償却率（老朽化率）が" + ka3v + "%です。" + ka3Body);
          kkCrossBoxShownF = true;
        }
      }
      if (KK && KK[curName] && KK[curName].ka1 != null) {
        var ka1v4 = KK[curName].ka1;
        var ka1Med4 = isPrefView ? KK_MEDIANS.ka1.pref : KK_MEDIANS.ka1.muni;
        var ka1Near4 = Math.abs(ka1v4 - ka1Med4) <= ka1Med4 * 0.1;
        var ka1High4 = ka1v4 > ka1Med4;
        if (!ka1Near4) {
          var ka1Judge4, ka1Body;
          if (!uHighF && ka1High4) { ka1Judge4 = "中央値より高め"; ka1Body = "<strong style='color:#c0623a;'>[公会計]</strong>資産規模は大きめですが、<strong style='color:#3a9970;'>[財政]</strong>将来への借金は軽めです。借金に頼らず資産を築けています。"; }
          else if (uHighF && ka1High4) { ka1Judge4 = "中央値より高め"; ka1Body = "<strong style='color:#c0623a;'>[公会計]</strong>資産規模・<strong style='color:#3a9970;'>[財政]</strong>将来への借金、どちらも大きめです。大型の資産整備を借金でまかなってきた可能性があります。"; }
          else if (uHighF && !ka1High4) { ka1Judge4 = "中央値より低め"; ka1Body = "<strong style='color:#c0623a;'>[公会計]</strong>資産規模は控えめですが、<strong style='color:#3a9970;'>[財政]</strong>将来への借金は重めです。資産形成に見合わない借金を抱えている可能性があります。"; }
          else { ka1Judge4 = "中央値より低め"; ka1Body = "<strong style='color:#c0623a;'>[公会計]</strong>資産規模・<strong style='color:#3a9970;'>[財政]</strong>将来への借金、どちらも小さめです。" + kkPerCapitaTrendNote(KK[curName], "ka1", ka1v4, cur.g) + "資産の規模と将来世代への負担のバランスは取れている状態です。"; }
          topSummaryHtml += kkCrossBox("🏛️ 総務省公式の組み合わせ分析<br><span style='color:#c0623a;'>住民一人当たり資産</span>×<span style='color:#3a9970;'>将来負担</span>",
            "将来への借金", cur.u+"%", uHighF?"重め":"軽め",
            "住民一人当たり資産額", ka1v4+"万円", ka1Judge4,
            curName + "は公会計でみた住民一人当たり資産額が" + ka1v4 + "万円です。" + ka1Body);
          kkCrossBoxShownF = true;
        }
      }
      if (KK && KK[curName] && KK[curName].ka6 != null) {
        var ka6v4 = KK[curName].ka6;
        var ka6Med4 = isPrefView ? KK_MEDIANS.ka6.pref : KK_MEDIANS.ka6.muni;
        var ka6Near4 = Math.abs(ka6v4 - ka6Med4) <= ka6Med4 * 0.1;
        var ka6High4 = ka6v4 > ka6Med4;
        if (!ka6Near4) {
          var ka6Judge4, ka6Body;
          if (!uHighF && !ka6High4) { ka6Judge4 = "中央値より低め"; ka6Body = "<strong style='color:#c0623a;'>[公会計]</strong>行政コスト・<strong style='color:#3a9970;'>[財政]</strong>将来への借金、どちらも軽めです。" + kkPerCapitaTrendNote(KK[curName], "ka6", ka6v4, cur.g) + "コンパクトな運営と言えます。"; }
          else if (uHighF && ka6High4) { ka6Judge4 = "中央値より高め"; ka6Body = "<strong style='color:#c0623a;'>[公会計]</strong>行政コスト・<strong style='color:#3a9970;'>[財政]</strong>将来への借金、どちらも重めです。サービス水準を維持するための借金が将来負担として残っている可能性があります。"; }
          else if (!uHighF && ka6High4) { ka6Judge4 = "中央値より高め"; ka6Body = "<strong style='color:#c0623a;'>[公会計]</strong>行政コストは高めですが、<strong style='color:#3a9970;'>[財政]</strong>将来への借金は軽めです。手厚いサービスを借金に頼らず提供できています。"; }
          else { ka6Judge4 = "中央値より低め"; ka6Body = "<strong style='color:#c0623a;'>[公会計]</strong>行政コストは抑えめですが、<strong style='color:#3a9970;'>[財政]</strong>将来への借金は重めです。過去の投資の返済が今の身軽さと引き換えになっている可能性があります。"; }
          topSummaryHtml += kkCrossBox("🏛️ 総務省公式の組み合わせ分析<br><span style='color:#c0623a;'>住民一人当たり行政コスト</span>×<span style='color:#3a9970;'>将来負担</span>",
            "将来への借金", cur.u+"%", uHighF?"重め":"軽め",
            "住民一人当たり行政コスト", ka6v4+"万円", ka6Judge4,
            curName + "は公会計でみた住民一人当たり行政コストが" + ka6v4 + "万円です。" + ka6Body);
          kkCrossBoxShownF = true;
        }
      }
    ...
    if (key === "childInvest" && cur && cur.ch!=null) {
      ...
      if (cur.ch < 70 && cur.x > 95) topSummaryHtml += "<div style='font-size:13px;color:#5a5a7a;margin-top:6px;'>⚠️ 子どもへの投資が少ない＋固定費が重い→固定費に圧迫されて将来世代への投資が削られている構図です</div>";
    ...
    if (key !== "health" && (hasHistory || hasGrowthHistory) && vals.length >= 2) {
      var validIdxT = [];
      ...
      if (validIdxT.length >= 2) {
        ...
        if (tdMain && tdMain.tier !== "横ばい") {
          ...
          topSummaryHtml += "<div style='font-size:13px;color:#5a5a7a;margin-top:6px;'>" + trendIcon + " " + META[key].label + "はこの" + validIdxT.length + "年で" + tdMain.text + (tdMain.dir==="増加"?"えています。":"っています。") + "</div>";
        }
      }
    }
  ...
  (function mmInit(){
    ...
    if (nkClose) nkClose.addEventListener("click", function(){ history.back(); });
...
/* ===== 公会計機能 ===== */
  ...
  function kkPerCapitaTrendNote(entry, code, curVal, g, unit) {
    if (!entry) return "";
    var oldVal = entry[code + "_r4"];
    var td = trendDescribe(oldVal, curVal, unit || "万円", 1);
    if (!td) return "";
    if (td.dir === "増加") {
      return "この5年で" + td.text + "えています。";
    }
    if (td.dir === "減少") {
      return "この5年で" + td.text + "っています。";
    }
    // 横ばい（3%未満の変化）の場合のみ、人口動向をふまえた補足を添える
    var popGrowing = g != null && g > 0.3;
    if (popGrowing) {
      return "この5年で" + td.text + "おり、人口が増えている一方でこの金額はあまり伸びていません。人口増加に整備・サービス拡充が追いついていない可能性も考えられます。";
    }
    return "この5年で" + td.text + "おり、老朽化による目減り分と新規投資がほぼ相殺されている可能性も考えられます。";
  }
  var KK_CROSSCHECK_CAVEAT = "<div style='background:rgba(160,139,232,0.08);border-radius:10px;padding:12px 14px;margin-top:10px;'>" +
    ...
    "</div>";
  function kkCrossBox(heading, zaiLabel, zaiVal, zaiJudge, kkLabel, kkVal, kkJudge, bodyText) {
    return "<div style='background:#e8f7f0;border:1px solid #6dcfad55;border-radius:12px;padding:14px 16px;margin-top:10px;'>" +
      ...
      "<div style='display:flex;gap:8px;margin-bottom:10px;'>" +
        "<div style='flex:1;background:white;border-radius:10px;padding:10px 10px;text-align:center;'>" +
        ...
        "</div>" +
      "</div>" +
      "<div style='font-size:15px;color:#3a5a4a;line-height:1.75;'>" + bodyText + "</div>" +
    "</div>";
  }
  ...
  function kkReciprocalCross(code, entryV, isPref, entry) {
    ...
    if (code === "ka4" && cur.sfs && cur.sfs > 0) {
      ...
      var judgeRec, bodyRec;
      if (!rHighRec && !ka4HighRec) { judgeRec = "やや少なめ"; bodyRec = "財政の体力は、<strong style='color:#3a9970;'>[財政]</strong>すぐ使える貯金・<strong style='color:#c0623a;'>[公会計]</strong>資産全体の自己資本どちらから見ても心もとない水準です。"; }
      else if (rHighRec && ka4HighRec) { judgeRec = "多め"; bodyRec = "財政の体力は、<strong style='color:#3a9970;'>[財政]</strong>すぐ使える貯金・<strong style='color:#c0623a;'>[公会計]</strong>資産全体の自己資本どちらから見ても厚めです。"; }
      else if (rHighRec && !ka4HighRec) { judgeRec = "多め"; bodyRec = "<strong style='color:#3a9970;'>[財政]</strong>すぐ使える貯金は多めですが、<strong style='color:#c0623a;'>[公会計]</strong>資産全体でみると借入への依存度は低くありません。貯金と長期的な財産形成は別物です。"; }
      else { judgeRec = "やや少なめ"; bodyRec = "<strong style='color:#3a9970;'>[財政]</strong>すぐ使える貯金は少なめですが、<strong style='color:#c0623a;'>[公会計]</strong>資産全体でみると借入に頼らず財産を築けています。日々の備えと長期的な財産形成は別物です。"; }
      return kkCrossBox("🔗 財政と合わせて見ると", "すぐ使える貯金", ratioRec.toFixed(1)+"%", judgeRec, "自己資本の厚み", entryV+"%", ka4HighRec?"中央値より高め":"中央値より低め", curName + "の財政調整基金は標準財政規模の" + ratioRec.toFixed(1) + "%です。" + bodyRec) + KK_CROSSCHECK_CAVEAT;
    }
    if (code === "ka7" && cur.d != null) {
      ...
      var judgeD, bodyD;
      if (!dHighRec && !ka7HighRec) { judgeD = "軽め"; bodyD = "借金の重さは、<strong style='color:#3a9970;'>[財政]</strong>毎年の返済負担・<strong style='color:#c0623a;'>[公会計]</strong>残高の規模どちらから見ても軽めです。"; }
      else if (dHighRec && ka7HighRec) { judgeD = "重め"; bodyD = "借金の重さは、<strong style='color:#3a9970;'>[財政]</strong>毎年の返済負担・<strong style='color:#c0623a;'>[公会計]</strong>残高の規模どちらから見ても重めです。"; }
      else if (!dHighRec && ka7HighRec) {
        judgeD = "軽め";
        var ka7Old_C = entry ? entry.ka7_r4 : null;
        var ka7Td_C = trendDescribe(ka7Old_C, entryV, "万円", 1);
        var ka7TrendC = kkMetricTrend(entry, "ka7", entryV);
        var ka7ReasonC = ka7TrendC === "declining"
          ? "住民一人当たり負債額はこの5年で" + (ka7Td_C ? ka7Td_C.text : "減少") + "っており、着実に返済が進んでいる長期返済中、という可能性も考えられます。"
          : "新しい借入も続いており、返済はこれから本格化する可能性も考えられます。";
        bodyD = "<strong style='color:#3a9970;'>[財政]</strong>毎年の返済負担は軽めに見えますが、<strong style='color:#c0623a;'>[公会計]</strong>借金の残高自体は大きめです。" + ka7ReasonC;
      }
      else {
        judgeD = "重め";
        var ka7Old_D = entry ? entry.ka7_r4 : null;
        var ka7Td_D = trendDescribe(ka7Old_D, entryV, "万円", 1);
        var ka7TrendD = kkMetricTrend(entry, "ka7", entryV);
        bodyD = ka7TrendD === "declining"
          ? "<strong style='color:#3a9970;'>[財政]</strong>毎年の返済負担は重めですが、<strong style='color:#c0623a;'>[公会計]</strong>借金の残高自体はそれほど大きくありません。住民一人当たり負債額はこの5年で" + (ka7Td_D ? ka7Td_D.text : "減少") + "っており、短期集中で返済を終えつつある可能性も考えられます。"
          : "<strong style='color:#3a9970;'>[財政]</strong>毎年の返済負担は重めですが、<strong style='color:#c0623a;'>[公会計]</strong>借金の残高自体はそれほど大きくありません。返済期間を短く設定している可能性も考えられます。";
      }
      return kkCrossBox("🔗 財政と合わせて見ると", "毎年の返済負担", cur.d+"%", judgeD, "借金残高そのもの", entryV+"万円", ka7HighRec?"中央値より高め":"中央値より低め", curName + "の実質公債費比率は" + cur.d + "%です。" + bodyD) + KK_CROSSCHECK_CAVEAT;
    }
    if ((code === "ka3" || code === "ka1" || code === "ka6") && cur.u != null) {
      var medRec = isPref ? KK_MEDIANS[code].pref : KK_MEDIANS[code].muni;
      var uHighRec = cur.u > 100;
      var nearRec = Math.abs(entryV - medRec) <= medRec * 0.1;
      var highRec = entryV > medRec;
      if (nearRec) return "";
      var judgeU, bodyU, heading, kkLabel, unit;
      if (code === "ka3") {
        kkLabel = "施設の老朽化率"; unit = "%";
        if (!uHighRec && !highRec) { judgeU = "軽め"; bodyU = "<strong style='color:#3a9970;'>[財政]</strong>将来への借金・<strong style='color:#c0623a;'>[公会計]</strong>施設の老朽化、どちらの面から見ても軽い状態です。"; }
        else if (uHighRec && highRec) { judgeU = "重め"; bodyU = "<strong style='color:#3a9970;'>[財政]</strong>将来への借金・<strong style='color:#c0623a;'>[公会計]</strong>施設の老朽化、どちらの面から見ても重い状態です。老朽化した施設の更新をこれから借金で行うと、将来負担がさらに増える可能性があります。"; }
        else if (!uHighRec && highRec) {
          judgeU = "軽め";
          var ka1v_B = entry ? entry.ka1 : null;
          var ka1Old_B = entry ? entry.ka1_r4 : null;
          var ka1Td_B = trendDescribe(ka1Old_B, ka1v_B, "万円", 1);
          var ka1TrendB = kkMetricTrend(entry, "ka1", ka1v_B);
          var ka3ReasonB = ka1TrendB === "growing"
            ? "住民一人当たり資産額はこの5年で" + (ka1Td_B ? ka1Td_B.text : "増加") + "えており、②既存施設を活用しながら、新しい整備も進めている可能性も考えられます。"
            : "①必要な投資が行われず、老朽化対策が先送りにされている可能性も考えられます。";
          bodyU = "<strong style='color:#3a9970;'>[財政]</strong>将来への借金は軽めですが、<strong style='color:#c0623a;'>[公会計]</strong>施設の老朽化は進んでいます。" + ka3ReasonB;
        }
        else { judgeU = "重め"; bodyU = "<strong style='color:#3a9970;'>[財政]</strong>将来への借金は重めですが、<strong style='color:#c0623a;'>[公会計]</strong>施設の老朽化は進んでいません。借金をしてでも施設の更新・整備を積極的に進めている可能性があります。"; }
        heading = "🏛️ 総務省公式の組み合わせ分析<br><span style='color:#3a9970;'>将来負担比率</span>×<span style='color:#c0623a;'>老朽化率</span>";
      } else if (code === "ka1") {
        kkLabel = "住民一人当たり資産額"; unit = "万円";
        if (!uHighRec && highRec) { judgeU = "軽め"; bodyU = "<strong style='color:#c0623a;'>[公会計]</strong>資産規模は大きめですが、<strong style='color:#3a9970;'>[財政]</strong>将来への借金は軽めです。借金に頼らず資産を築けています。"; }
        else if (uHighRec && highRec) { judgeU = "重め"; bodyU = "<strong style='color:#c0623a;'>[公会計]</strong>資産規模・<strong style='color:#3a9970;'>[財政]</strong>将来への借金、どちらも大きめです。大型の資産整備を借金でまかなってきた可能性があります。"; }
        else if (uHighRec && !highRec) { judgeU = "重め"; bodyU = "<strong style='color:#c0623a;'>[公会計]</strong>資産規模は控えめですが、<strong style='color:#3a9970;'>[財政]</strong>将来への借金は重めです。資産形成に見合わない借金を抱えている可能性があります。"; }
        else { judgeU = "軽め"; bodyU = "<strong style='color:#c0623a;'>[公会計]</strong>資産規模・<strong style='color:#3a9970;'>[財政]</strong>将来への借金、どちらも小さめです。" + kkPerCapitaTrendNote(entry, "ka1", entryV, cur.g) + "資産の規模と将来世代への負担のバランスは取れている状態です。"; }
        heading = "🏛️ 総務省公式の組み合わせ分析<br><span style='color:#c0623a;'>住民一人当たり資産</span>×<span style='color:#3a9970;'>将来負担</span>";
      } else {
        kkLabel = "住民一人当たり行政コスト"; unit = "万円";
        if (!uHighRec && !highRec) { judgeU = "軽め"; bodyU = "<strong style='color:#c0623a;'>[公会計]</strong>行政コスト・<strong style='color:#3a9970;'>[財政]</strong>将来への借金、どちらも軽めです。" + kkPerCapitaTrendNote(entry, "ka6", entryV, cur.g) + "コンパクトな運営と言えます。"; }
        else if (uHighRec && highRec) { judgeU = "重め"; bodyU = "<strong style='color:#c0623a;'>[公会計]</strong>行政コスト・<strong style='color:#3a9970;'>[財政]</strong>将来への借金、どちらも重めです。サービス水準を維持するための借金が将来負担として残っている可能性があります。"; }
        else if (!uHighRec && highRec) { judgeU = "軽め"; bodyU = "<strong style='color:#c0623a;'>[公会計]</strong>行政コストは高めですが、<strong style='color:#3a9970;'>[財政]</strong>将来への借金は軽めです。手厚いサービスを借金に頼らず提供できています。"; }
        else { judgeU = "重め"; bodyU = "<strong style='color:#c0623a;'>[公会計]</strong>行政コストは抑えめですが、<strong style='color:#3a9970;'>[財政]</strong>将来への借金は重めです。過去の投資の返済が今の身軽さと引き換えになっている可能性があります。"; }
        heading = "🏛️ 総務省公式の組み合わせ分析<br><span style='color:#c0623a;'>住民一人当たり行政コスト</span>×<span style='color:#3a9970;'>将来負担</span>";
      }
      return kkCrossBox(heading, "将来への借金", cur.u+"%", judgeU, kkLabel, entryV+unit, highRec?"中央値より高め":"中央値より低め", curName + "の将来負担比率は" + cur.u + "%です。" + bodyU) + KK_CROSSCHECK_CAVEAT;
    }
    return "";
  }
  var KK_META = {
  ...
  function kkOpenDetail(code, skipPush){
    ...
    var kkVals = [entry[code]];
    var n2 = 1;
    while (entry[code + "_r" + n2] != null) { kkVals.push(entry[code + "_r" + n2]); n2++; }
    kkVals.reverse(); // 古い年→新しい年の順にする
    var kkCovidNote = "";
    if (kkVals.length >= 2 && kkVals.every(function(v){ return v != null; })) {
      ...
      var kkTd = trendDescribe(kkVals[0], kkVals[kkVals.length-1], meta.unit, 1);
      if (kkTd && kkTd.tier !== "横ばい") {
        var kkTrendIcon = kkTd.dir === "増加" ? "📈" : "📉";
        kkCovidNote += "<div style='font-size:14px;color:#7a7a90;margin-top:6px;'>" + kkTrendIcon + " " + meta.label + "はこの" + kkVals.length + "年で" + kkTd.text + (kkTd.dir==="増加"?"えています。":"っています。") + "</div>";
      }
      ...
      for (var kj=0; kj<kkVals.length; kj++){
        ...
        if (kkLast && kkIsValley) kkDots += "<text x='"+pxk(kj)+"' y='"+(pyk(kkVals[kj])+19)+"' text-anchor='middle' font-size='12' fill='"+kkC+"' font-weight='700'>"+kkLbl+"</text>";
        else if (kkLast) kkDots += "<text x='"+pxk(kj)+"' y='"+(pyk(kkVals[kj])-9)+"' text-anchor='middle' font-size='12' fill='"+kkC+"' font-weight='700'>"+kkLbl+"</text>";
        else if (kkIsValley) kkDots += "<text x='"+pxk(kj)+"' y='"+(pyk(kkVals[kj])+16)+"' text-anchor='middle' font-size='9' fill='"+kkC+"' opacity='0.75'>"+kkLbl+"</text>";
        else kkDots += "<text x='"+pxk(kj)+"' y='"+(pyk(kkVals[kj])-8)+"' text-anchor='middle' font-size='9' fill='"+kkC+"' opacity='0.75'>"+kkLbl+"</text>";
      }
