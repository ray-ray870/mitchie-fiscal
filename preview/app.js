...
/* ===== 公会計機能 ===== */
  ...
  function kkRadarSvg(nm, entry, isPref, prefName){
    ...
    var chartBox = "<div style='position:relative;width:clamp(70px,calc(100vw - 272px),260px);height:clamp(70px,calc(100vw - 272px),260px);margin:0 auto;'>" +
      ...
      "</div>";
    var legendRow = "<div style='grid-column:1 / -1;display:flex;align-items:center;justify-content:flex-end;gap:3px;font-size:10px;color:#6b6862;padding-right:4px;width:100%;box-sizing:border-box;'>" +
