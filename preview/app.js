(function() {
  ...
  function render(found, skipHistory, keepScroll) {
    ...
    el.innerHTML =
      ...
      "<h2 class='sr-only'>財政指標の一覧</h2><div class='grid'>" +
        ...
        "<div class='stat' id='s8' role='button' tabindex='0' style='background:#6dcfad18;border-color:#6dcfad44;'><div class='si'>🎁</div><div class='sl'>ふるさと納税受入額</div><div class='sv' style='color:#6dcfad;'>"+(d.fu!=null?fmtManOku(d.fu):"—")+"</div><div class='su'>詳細を見る ▶</div></div>" +
      "</div>" +
  ...
  function openD(key, skipPush) {
    ...
    if (key === "furusato") {
      ...
      if (DB && cur) {
        if (isPrefViewF) {
          ...
          if (myRankPF) {
            ...
            rankHtmlF = "<div style='display:inline-flex;align-items:center;gap:6px;background:#6dcfad18;border:1.5px solid #6dcfad44;border-radius:12px;padding:6px 14px;margin:6px 0 12px;font-size:14px;font-weight:700;color:#2a8a6a;'>" +
              (medalPF?medalPF+" ":"") + "全国 " + prefListF.length + "都道府県中 <span style='font-size:17px;'>" + myRankPF + "位</span></div><br>";
          }
        } else {
          ...
          if (myRankNF) {
            ...
            linesF += "<div style='display:inline-flex;align-items:center;gap:6px;background:#6dcfad18;border:1.5px solid #6dcfad44;border-radius:12px;padding:6px 14px;margin:0 0 6px;font-size:14px;font-weight:700;color:#2a8a6a;'>" + (medalNF?medalNF+" ":"") + "全国 " + natListF.length + "自治体中 <span style='font-size:17px;'>" + myRankNF + "位</span></div>";
          }
          if (myRankPrefF) {
            var medalPF2 = medalFor(myRankPrefF, false);
            linesF += "<div style='display:inline-flex;align-items:center;gap:6px;background:#6dcfad18;border:1.5px solid #6dcfad44;border-radius:12px;padding:6px 14px;margin:0;font-size:14px;font-weight:700;color:#2a8a6a;'>" + (medalPF2?medalPF2+" ":"") + cur.p + "内 " + prefListF2.length + "自治体中 <span style='font-size:17px;'>" + myRankPrefF + "位</span></div>";
          }
          rankHtmlF = linesF ? (linesF + "<br>") : "";
        }
      }
      ...
      var descHtmlF = "<div style='font-size:15px;color:#3a3a4a;line-height:1.8;'>" +
        "<strong style='font-size:16px;'>R7年度 全国のふるさと納税受入額は約" + natTotalOkuF + "億円です。</strong><br><br>" +
      ...
      document.getElementById("shDesc").innerHTML = "<div style='border-top:1px dashed #d8d5e8;margin:22px 0;'></div><div style='font-size:16px;font-weight:700;color:#3a6ee8;margin-bottom:8px;'>"+m.label+"とは？</div>" + descHtmlF;
