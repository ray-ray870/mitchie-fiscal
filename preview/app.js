    ...
    if (key === "furusato") {
      ...
      if (fuH.length >= 2 && fuH[0] > 0) {
        ...
        if (volatileFu && peakIdxF !== lastIdxF && afterPeakRatioF <= 0.6) {
          topSummaryHtmlF += "<div style='font-size:13px;color:#5a5a7a;margin-top:6px;'>📊 "+yrLabelsShortF[peakIdxF]+"年度が最も多く"+fmtManOku(maxFu)+"でした。その後は減少しており、直近の"+yrLabelsShortF[lastIdxF]+"年度は"+fmtManOku(fuH[lastIdxF])+"です</div>";
        } else if (ratioF >= 1.5) {
          ...
          topSummaryHtmlF += "<div style='font-size:13px;color:#5a5a7a;margin-top:6px;'>📊 受入額は年によって変動が大きく、"+yrLabelsShortF[peakIdxF]+"年度が最も多い"+fmtManOku(maxFu)+"でした</div>";
        } else {
