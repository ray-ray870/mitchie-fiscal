...
if (key === "growth" && cur && cur.pop) {
  ...
  function nkPrefRow(list, idx, mineSet){
    ...
    return "<div class='nk-pref-row"+(mine?" mine":"")+"'>"+
      ...
      "<span class='nk-pref-name'>"+o.k+(mine?" <span class='nk-mine-chip'>Myみっちー</span>":"")+"</span>"+
...
/* ===== 公会計機能 ===== */
  ...
  function kkRadarSvg(nm, entry, isPref, prefName){
    ...
    var chartBox = "<div style='position:relative;width:clamp(70px,calc(100vw - 272px),260px);height:clamp(70px,calc(100vw - 272px),260px);margin:0 auto;'>" +
      ...
      "</div>";
    var legendRow = "<div style='grid-column:1 / -1;justify-self:stretch;width:100%;box-sizing:border-box;text-align:right;padding-right:4px;font-size:10px;color:#6b6862;line-height:1.6;'>" +
      "<span style='display:inline-block;'><svg width='24' height='6' style='display:inline-block;vertical-align:middle;'><line x1='1' y1='3' x2='23' y2='3' stroke='#6b6862' stroke-width='2' stroke-dasharray='4,3'/></svg> 比較基準<br>（全国中央値、収支のみ類似団体中央値）</span>" +
      "</div>";
