  ...
  function openD(key, skipPush) {
    ...
    if (key === "reserve" && cur && cur.sfs && cur.sfs > 0) {
      ...
      if (KK && KK[curName] && KK[curName].ka4 != null) {
        ...
        if (ka4Near) {
          ka4Judge = "中央値とほぼ同水準";
          linkMsgR = "<strong style='color:#c0623a;'>[公会計]</strong>純資産比率は中央値とほぼ同水準（僅差）のため、単独の差では大きな違いとは言えません。"
            + (rHigh ? "<strong style='color:#3a9970;'>[財政]</strong>すぐ使える貯金は多めです。" : "<strong style='color:#3a9970;'>[財政]</strong>すぐ使える貯金はやや少なめです。");
...
if (key === "growth" && cur && cur.pop) {
    ...
    if (key === "debt" && cur) {
      ...
      if (KK && KK[curName] && KK[curName].ka7 != null) {
        ...
        if (ka7Near) {
          ka7Judge = "中央値とほぼ同水準";
          linkMsgD = "<strong style='color:#c0623a;'>[公会計]</strong>住民一人当たり負債額は中央値とほぼ同水準（僅差）のため、単独の差では大きな違いとは言えません。"
            + (dHigh ? "<strong style='color:#3a9970;'>[財政]</strong>毎年の返済負担はやや重めです。" : "<strong style='color:#3a9970;'>[財政]</strong>毎年の返済負担は軽めです。");
    ...
    if (key === "future" && cur) {
      ...
      if (KK && KK[curName] && KK[curName].ka3 != null) {
        ...
        var uHigh3 = cur.u > 100;
        var ka3Near = Math.abs(ka3v - ka3Med) <= ka3Med * 0.1;
        var ka3High = ka3v > ka3Med;
        var linkMsg3, ka3Judge;
        if (ka3Near) {
          ka3Judge = "中央値とほぼ同水準";
          linkMsg3 = "<strong style='color:#c0623a;'>[公会計]</strong>有形固定資産減価償却率（老朽化率）は中央値とほぼ同水準（僅差）のため、単独の差では大きな違いとは言えません。"
            + (uHigh3 ? "<strong style='color:#3a9970;'>[財政]</strong>将来への借金はやや重めです。" : "<strong style='color:#3a9970;'>[財政]</strong>将来への借金は軽めです。");
        } else if (!uHigh3 && !ka3High) {
          ka3Judge = "中央値より低め";
          linkMsg3 = "<strong style='color:#3a9970;'>[財政]</strong>将来への借金・<strong style='color:#c0623a;'>[公会計]</strong>施設の老朽化、どちらの面から見ても軽い状態です。";
        } else if (uHigh3 && ka3High) {
          ka3Judge = "中央値より高め";
          linkMsg3 = "<strong style='color:#3a9970;'>[財政]</strong>将来への借金・<strong style='color:#c0623a;'>[公会計]</strong>施設の老朽化、どちらの面から見ても重い状態です。老朽化した施設の更新をこれから借金で行うと、将来負担がさらに増える可能性があります。";
        } else if (!uHigh3 && ka3High) {
          ka3Judge = "中央値より高め";
          linkMsg3 = "<strong style='color:#3a9970;'>[財政]</strong>将来への借金は軽めですが、<strong style='color:#c0623a;'>[公会計]</strong>施設の老朽化は進んでいます。①必要な投資が行われず、老朽化対策が先送りにされている可能性、②既存施設を活用して財政負担を抑えている可能性、が考えられます。";
        } else {
          ka3Judge = "中央値より低め";
          linkMsg3 = "<strong style='color:#3a9970;'>[財政]</strong>将来への借金は重めですが、<strong style='color:#c0623a;'>[公会計]</strong>施設の老朽化は進んでいません。借金をしてでも施設の更新・整備を積極的に進めている可能性があります。";
        }
        topSummaryHtml += kkCrossBox("🏛️ 総務省公式の組み合わせ分析（将来負担比率×老朽化率）",
          "将来への借金", cur.u+"%", uHigh3?"重め":"軽め",
          "施設の老朽化率", ka3v+"%", ka3Judge,
          curName + "は公会計でみた有形固定資産減価償却率（老朽化率）が" + ka3v + "%です。" + linkMsg3);
      }
      if (KK && KK[curName] && KK[curName].ka1 != null) {
        ...
        var uHigh4 = cur.u > 100;
        var ka1Near4 = Math.abs(ka1v4 - ka1Med4) <= ka1Med4 * 0.1;
        var ka1High4 = ka1v4 > ka1Med4;
        var linkMsg4, ka1Judge4;
        if (ka1Near4) {
          ka1Judge4 = "中央値とほぼ同水準";
          linkMsg4 = "<strong style='color:#c0623a;'>[公会計]</strong>住民一人当たり資産額は中央値とほぼ同水準（僅差）のため、単独の差では大きな違いとは言えません。"
            + (uHigh4 ? "<strong style='color:#3a9970;'>[財政]</strong>将来への借金はやや重めです。" : "<strong style='color:#3a9970;'>[財政]</strong>将来への借金は軽めです。");
        } else if (!uHigh4 && ka1High4) {
          ka1Judge4 = "中央値より高め";
          linkMsg4 = "<strong style='color:#c0623a;'>[公会計]</strong>資産規模は大きめですが、<strong style='color:#3a9970;'>[財政]</strong>将来への借金は軽めです。借金に頼らず資産を築けています。";
        } else if (uHigh4 && ka1High4) {
          ka1Judge4 = "中央値より高め";
          linkMsg4 = "<strong style='color:#c0623a;'>[公会計]</strong>資産規模・<strong style='color:#3a9970;'>[財政]</strong>将来への借金、どちらも大きめです。大型の資産整備を借金でまかなってきた可能性があります。";
        } else if (uHigh4 && !ka1High4) {
          ka1Judge4 = "中央値より低め";
          linkMsg4 = "<strong style='color:#c0623a;'>[公会計]</strong>資産規模は控えめですが、<strong style='color:#3a9970;'>[財政]</strong>将来への借金は重めです。資産形成に見合わない借金を抱えている可能性があります。";
        } else {
          ka1Judge4 = "中央値より低め";
          linkMsg4 = "<strong style='color:#c0623a;'>[公会計]</strong>資産規模・<strong style='color:#3a9970;'>[財政]</strong>将来への借金、どちらも小さめです。大きな整備は行っていませんが、身の丈に合った運営とも言えます。";
        }
        topSummaryHtml += kkCrossBox("🏛️ 総務省公式の組み合わせ分析（住民一人当たり資産×将来負担）",
          "将来への借金", cur.u+"%", uHigh4?"重め":"軽め",
          "住民一人当たり資産額", ka1v4+"万円", ka1Judge4,
          curName + "は公会計でみた住民一人当たり資産額が" + ka1v4 + "万円です。" + linkMsg4);
      }
      if (KK && KK[curName] && KK[curName].ka6 != null) {
        ...
        var uHigh5 = cur.u > 100;
        var ka6Near4 = Math.abs(ka6v4 - ka6Med4) <= ka6Med4 * 0.1;
        var ka6High4 = ka6v4 > ka6Med4;
        var linkMsg5, ka6Judge4;
        if (ka6Near4) {
          ka6Judge4 = "中央値とほぼ同水準";
          linkMsg5 = "<strong style='color:#c0623a;'>[公会計]</strong>住民一人当たり行政コストは中央値とほぼ同水準（僅差）のため、単独の差では大きな違いとは言えません。"
            + (uHigh5 ? "<strong style='color:#3a9970;'>[財政]</strong>将来への借金はやや重めです。" : "<strong style='color:#3a9970;'>[財政]</strong>将来への借金は軽めです。");
        } else if (!uHigh5 && !ka6High4) {
          ka6Judge4 = "中央値より低め";
          linkMsg5 = "<strong style='color:#c0623a;'>[公会計]</strong>行政コスト・<strong style='color:#3a9970;'>[財政]</strong>将来への借金、どちらも軽めです。コンパクトな運営と言えます。";
        } else if (uHigh5 && ka6High4) {
          ka6Judge4 = "中央値より高め";
          linkMsg5 = "<strong style='color:#c0623a;'>[公会計]</strong>行政コスト・<strong style='color:#3a9970;'>[財政]</strong>将来への借金、どちらも重めです。サービス水準を維持するための借金が将来負担として残っている可能性があります。";
        } else if (!uHigh5 && ka6High4) {
          ka6Judge4 = "中央値より高め";
          linkMsg5 = "<strong style='color:#c0623a;'>[公会計]</strong>行政コストは高めですが、<strong style='color:#3a9970;'>[財政]</strong>将来への借金は軽めです。手厚いサービスを借金に頼らず提供できています。";
        } else {
          ka6Judge4 = "中央値より低め";
          linkMsg5 = "<strong style='color:#c0623a;'>[公会計]</strong>行政コストは抑えめですが、<strong style='color:#3a9970;'>[財政]</strong>将来への借金は重めです。過去の投資の返済が今の身軽さと引き換えになっている可能性があります。";
        }
        topSummaryHtml += kkCrossBox("🏛️ 総務省公式の組み合わせ分析（住民一人当たり行政コスト×将来負担）",
          "将来への借金", cur.u+"%", uHigh5?"重め":"軽め",
          "住民一人当たり行政コスト", ka6v4+"万円", ka6Judge4,
          curName + "は公会計でみた住民一人当たり行政コストが" + ka6v4 + "万円です。" + linkMsg5);
      }
    }
...
/* ===== 公会計機能 ===== */
  ...
  function kkOpenDetail(code, skipPush){
    ...
    if (kkVals.length >= 2 && kkVals.every(function(v){ return v != null; })) {
      ...
      document.getElementById("shTop").innerHTML = cmpHtml + kkCovidNote;
      ...
      document.getElementById("shTop").innerHTML = cmpHtml;
      document.getElementById("spSvg").innerHTML = "";
      document.getElementById("spSvg").style.height = "0px";
      document.getElementById("spLabels").innerHTML = "";
