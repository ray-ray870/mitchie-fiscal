...
/* ===== 公会計機能 ===== */
  ...
  function kkRadarSvg(nm, entry, isPref, prefName){
    ...
    var chartBox = "<div style='position:relative;width:clamp(70px,calc(100vw - 272px),260px);height:clamp(70px,calc(100vw - 272px),260px);margin:0 auto;'>" +
      ...
      "</div>";
    var legendRow = "<div style='display:flex;align-items:center;justify-content:flex-end;gap:3px;font-size:10px;color:#6b6862;padding-right:2px;width:100%;box-sizing:border-box;justify-self:stretch;'>" +
      "<svg width='24' height='6' style='display:inline-block;flex-shrink:0;'><line x1='1' y1='3' x2='23' y2='3' stroke='#6b6862' stroke-width='2' stroke-dasharray='4,3'/></svg>比較基準（収支のみ類似団体中央値）" +
      "</div>";
