    ...
    if (key === "reserve" && cur && cur.sfs && cur.sfs > 0) {
      ...
      if (KK && KK[curName] && KK[curName].ka4 != null) {
        ...
        topSummaryHtml += kkCrossBox("🔗 公会計と合わせて見ると",
          ...
          "純資産比率", ka4v+"%", ka4Judge,
          curName + "は公会計でみた純資産比率（自己資本の厚み）が" + ka4v + "%です。" + linkMsgR,
    ...
    if (key === "debt" && cur) {
      ...
      if (KK && KK[curName] && KK[curName].ka7 != null) {
        ...
        topSummaryHtml += kkCrossBox("🔗 公会計と合わせて見ると",
          ...
          curName + "は公会計でみた住民一人当たり負債額（借金残高そのもの）が" + ka7v + "万円です。" + linkMsgD,
...
/* ===== 公会計機能 ===== */
  ...
  function kkReciprocalCross(code, entryV, isPref, entry) {
    ...
    if (code === "ka4" && cur.sfs && cur.sfs > 0) {
      ...
      return kkCrossBox("🔗 財政と合わせて見ると", "財政調整基金残高", ratioRec.toFixed(1)+"%", judgeRec, "純資産比率", entryV+"%", ka4HighRec?"中央値より高め":"中央値より低め", curName + "の財政調整基金（すぐ使える貯金）は標準財政規模の" + ratioRec.toFixed(1) + "%です。" + bodyRec, true, rTrendPhrase, ka4TrendPhrase) + KK_CROSSCHECK_CAVEAT;
    }
    if (code === "ka7" && cur.d != null) {
      ...
      return kkCrossBox("🔗 財政と合わせて見ると", "実質公債費比率", cur.d+"%", judgeD, "住民一人当たり負債額", entryV+"万円", ka7HighRec?"中央値より高め":"中央値より低め", curName + "の実質公債費比率（毎年の返済負担）は" + cur.d + "%です。" + bodyD, true, dTrendPhrase, ka7TrendPhrase) + KK_CROSSCHECK_CAVEAT;
    }
