  ...
  function openD(key, skipPush) {
    ...
    if (key === "reserve" && cur && cur.sfs && cur.sfs > 0) {
      ...
      if (KK && KK[curName] && KK[curName].ka4 != null) {
        ...
        var factR, analysisR, ka4Judge;
        if (!ka4Near) {
        if (!rHigh && !ka4High) {
          ka4Judge = "中央値より低め";
          factR = "財政の体力は、<strong style='color:#3a9970;'>[財政]</strong>すぐ使える貯金・<strong style='color:#c0623a;'>[公会計]</strong>資産全体の自己資本どちらから見ても心もとない水準です。";
          analysisR = "";
        } else if (rHigh && ka4High) {
          ka4Judge = "中央値より高め";
          factR = "財政の体力は、<strong style='color:#3a9970;'>[財政]</strong>すぐ使える貯金・<strong style='color:#c0623a;'>[公会計]</strong>資産全体の自己資本どちらから見ても厚めです。";
          analysisR = "";
        } else if (rHigh && !ka4High) {
          ka4Judge = "中央値より低め";
          factR = "<strong style='color:#3a9970;'>[財政]</strong>すぐ使える貯金は多めですが、<strong style='color:#c0623a;'>[公会計]</strong>資産全体でみると借入への依存度は低くありません。";
          analysisR = "貯金と長期的な財産形成は別物です。";
        } else {
          ka4Judge = "中央値より高め";
          factR = "<strong style='color:#3a9970;'>[財政]</strong>すぐ使える貯金は少なめですが、<strong style='color:#c0623a;'>[公会計]</strong>資産全体でみると借入に頼らず財産を築けています。";
          analysisR = "日々の備えと長期的な財産形成は別物です。";
        }
        topSummaryHtml += kkCrossBox("🔗 公会計と比べてみると",
          "財政調整基金残高", ratio.toFixed(1)+"%", rHigh?"多め":"やや少なめ",
          "純資産比率", ka4v+"%", ka4Judge,
          curName + "は公会計でみた純資産比率（自己資本の厚み）が" + ka4v + "%です。" + factR, analysisR,
...
if (key === "growth" && cur && cur.pop) {
    ...
    if (key === "debt" && cur) {
      ...
      if (KK && KK[curName] && KK[curName].ka7 != null) {
        ...
        var factD, analysisD, ka7Judge;
        if (ka7Near) {
          ka7Judge = "中央値とほぼ同水準";
          factD = "<strong style='color:#c0623a;'>[公会計]</strong>住民一人当たり負債額は中央値とほぼ同水準です。<strong style='color:#3a9970;'>[財政]</strong>毎年の返済負担は" + (dHigh?"重め":"軽め") + "です。";
          analysisD = "この" + (dHigh?"重さ":"軽さ") + "は負債額以外の要因によるものと考えられます。";
        } else if (!dHigh && !ka7High) {
          ka7Judge = "中央値より低め";
          factD = "借金の重さは、<strong style='color:#3a9970;'>[財政]</strong>毎年の返済負担・<strong style='color:#c0623a;'>[公会計]</strong>残高の規模どちらから見ても軽めです。";
          analysisD = "";
        } else if (dHigh && ka7High) {
          ka7Judge = "中央値より高め";
          factD = "借金の重さは、<strong style='color:#3a9970;'>[財政]</strong>毎年の返済負担・<strong style='color:#c0623a;'>[公会計]</strong>残高の規模どちらから見ても重めです。";
          analysisD = "";
        } else if (!dHigh && ka7High) {
          ka7Judge = "中央値より高め";
          factD = "<strong style='color:#3a9970;'>[財政]</strong>毎年の返済負担は軽めに見えますが、<strong style='color:#c0623a;'>[公会計]</strong>借金の残高自体は大きめです。";
          ...
          ka7Judge = "中央値より低め";
          factD = "<strong style='color:#3a9970;'>[財政]</strong>毎年の返済負担は重めですが、<strong style='color:#c0623a;'>[公会計]</strong>借金の残高自体はそれほど大きくありません。";
        ...
        topSummaryHtml += kkCrossBox("🔗 公会計と比べてみると",
          ...
          curName + "は公会計でみた住民一人当たり負債額（借金残高そのもの）が" + ka7v + "万円です。" + factD, analysisD,
...
/* ===== 公会計機能 ===== */
  ...
  function buildFutureComboBody(code, kkVal, med, uHigh, entry) {
    ...
    if (near) {
      ...
      return {judge:judge, fact:fact, analysis:analysis};
    }
    if (code === "ka3") {
  ...
  function buildFutureComboBox(code, kkVal, isPrefView, curObj, curNameStr, entry, reverseOrder, boxNumber) {
    ...
    return kkCrossBox(heading,
      ...
      curNameStr + "は公会計でみた" + m.fullLabel + "が" + kkVal + m.unit + "です。" + r.fact, r.analysis,
      reverseOrder, uTrendPhrase, kkTrendPhrase);
  }
  function kkCrossBox(heading, zaiLabel, zaiVal, zaiJudge, kkLabel, kkVal, kkJudge, factText, analysisText, reverse, zaiTrendPhrase, kkTrendPhrase) {
    ...
    var factHtml = "<div style='background:white;border-radius:10px;padding:10px 12px;margin-bottom:"+(analysisText?"8px":"0")+";'>" +
      "<div style='font-size:13px;font-weight:700;color:#3a6ee8;margin-bottom:4px;'>📊 数字から分かること</div>" +
      "<div style='font-size:14px;color:#333;line-height:1.7;'>" + factText + "</div>" +
    "</div>";
  ...
  function kkReciprocalCross(code, entryV, isPref, entry) {
    ...
    if (code === "ka4" && cur.sfs && cur.sfs > 0) {
      ...
      var judgeRec, factRec, analysisRec;
      if (!rHighRec && !ka4HighRec) { judgeRec = "やや少なめ"; factRec = "財政の体力は、<strong style='color:#3a9970;'>[財政]</strong>すぐ使える貯金・<strong style='color:#c0623a;'>[公会計]</strong>資産全体の自己資本どちらから見ても心もとない水準です。"; analysisRec = ""; }
      else if (rHighRec && ka4HighRec) { judgeRec = "多め"; factRec = "財政の体力は、<strong style='color:#3a9970;'>[財政]</strong>すぐ使える貯金・<strong style='color:#c0623a;'>[公会計]</strong>資産全体の自己資本どちらから見ても厚めです。"; analysisRec = ""; }
      else if (rHighRec && !ka4HighRec) { judgeRec = "多め"; factRec = "<strong style='color:#3a9970;'>[財政]</strong>すぐ使える貯金は多めですが、<strong style='color:#c0623a;'>[公会計]</strong>資産全体でみると借入への依存度は低くありません。"; analysisRec = "貯金と長期的な財産形成は別物です。"; }
      else { judgeRec = "やや少なめ"; factRec = "<strong style='color:#3a9970;'>[財政]</strong>すぐ使える貯金は少なめですが、<strong style='color:#c0623a;'>[公会計]</strong>資産全体でみると借入に頼らず財産を築けています。"; analysisRec = "日々の備えと長期的な財産形成は別物です。"; }
      ...
      return kkCrossBox("🔗 財政と比べてみると", "財政調整基金残高", ratioRec.toFixed(1)+"%", judgeRec, "純資産比率", entryV+"%", ka4HighRec?"中央値より高め":"中央値より低め", curName + "の財政調整基金（すぐ使える貯金）は標準財政規模の" + ratioRec.toFixed(1) + "%です。" + factRec, analysisRec, true, rTrendPhrase, ka4TrendPhrase) + KK_CROSSCHECK_CAVEAT;
    }
    if (code === "ka7" && cur.d != null) {
      ...
      var judgeD, factD2, analysisD2;
      if (!dHighRec && !ka7HighRec) { judgeD = "軽め"; factD2 = "借金の重さは、<strong style='color:#3a9970;'>[財政]</strong>毎年の返済負担・<strong style='color:#c0623a;'>[公会計]</strong>残高の規模どちらから見ても軽めです。"; analysisD2 = ""; }
      else if (dHighRec && ka7HighRec) { judgeD = "重め"; factD2 = "借金の重さは、<strong style='color:#3a9970;'>[財政]</strong>毎年の返済負担・<strong style='color:#c0623a;'>[公会計]</strong>残高の規模どちらから見ても重めです。"; analysisD2 = ""; }
      else if (!dHighRec && ka7HighRec) {
        judgeD = "軽め";
        factD2 = "<strong style='color:#3a9970;'>[財政]</strong>毎年の返済負担は軽めに見えますが、<strong style='color:#c0623a;'>[公会計]</strong>借金の残高自体は大きめです。";
        ...
        judgeD = "重め";
        factD2 = "<strong style='color:#3a9970;'>[財政]</strong>毎年の返済負担は重めですが、<strong style='color:#c0623a;'>[公会計]</strong>借金の残高自体はそれほど大きくありません。";
      ...
      return kkCrossBox("🔗 財政と比べてみると", "実質公債費比率", cur.d+"%", judgeD, "住民一人当たり負債額", entryV+"万円", ka7HighRec?"中央値より高め":"中央値より低め", curName + "の実質公債費比率（毎年の返済負担）は" + cur.d + "%です。" + factD2, analysisD2, true, dTrendPhrase, ka7TrendPhrase) + KK_CROSSCHECK_CAVEAT;
    }
