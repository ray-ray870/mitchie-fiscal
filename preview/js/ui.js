    ...
    if (key === "furusato") {
      ...
      var topFuRowsHtml = topFuList.map(function(row, i){
        ...
        var mmChip = (typeof mmIsMine === "function" && mmIsMine(row.name))
          ...
          : "";
        return "<div style='display:flex;align-items:center;gap:10px;background:#fff;border:1px solid #e6e3f2;border-radius:12px;padding:9px 12px;margin-bottom:6px;'>" +
      ...
      var furuRankBoxHtml = "<div id='furuRankBox' style='display:none;margin-top:10px;'>" +
      ...
      var descHtmlF = "<div style='font-size:15px;color:#3a3a4a;line-height:1.8;margin-bottom:14px;'>" +
        ...
        "<div style='text-align:center;margin-top:10px;'><button type='button' onclick=\"var b=document.getElementById('furuRankBox');var t=document.getElementById('furuRankBtnLabel');if(b.style.display==='none'){b.style.display='block';t.innerHTML='🏆 全国ランキングTOP10 ▲';}else{b.style.display='none';t.innerHTML='🏆 全国ランキングTOP10 ▶';}\" style='display:inline-flex;align-items:center;justify-content:center;gap:6px;background:linear-gradient(135deg,#f7b955,#f0876a);color:#fff;font-weight:700;font-size:13px;border:none;border-radius:999px;padding:9px 16px;box-shadow:0 3px 8px rgba(240,135,106,0.35);cursor:pointer;font-family:inherit;'><span id='furuRankBtnLabel'>🏆 全国ランキングTOP10 ▶</span></button></div>" +
        furuRankBoxHtml +
        "</div>" +
