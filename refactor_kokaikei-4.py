...
DESC_FINAL_NEW = 'document.getElementById("shDesc").innerHTML = rankHtml + topSummaryHtml + (topSummaryHtml ? "<div style=\'border-top:1px dashed #d8d5e8;margin:14px 0;\'></div>" : "") + descHtml;'
